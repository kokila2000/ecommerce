...
<h1 class="text-warning font-monospace text-center my-3">TRADITIONAL LEHENGA</h1>
...
if($check_page ==='Traditional Lehenga'){

echo "
<div class='col-md-6 col-lg-4 m-auto mb-3'>
<form action='Insertcart.php'method='POST'>
<div class='card m-auto' style='width: 18rem;'>
  <img src='../admin/product.php/$row[PImage]' class='card-img-top m-auto' style='width : 245px;'>
